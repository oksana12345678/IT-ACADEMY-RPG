  ...
  return (
    <div className="flex w-full h-full xl:py-3 xl:px-15 md:py-8 md:px-8 py-3 justify-center items-center xl:items-start">
      <div className="flex flex-col h-full  w-fit  xl:items-start">
        <h2 className="text-[#FF9900] font-semibold xl:text-3xl md:text-2xl xl:pb-8 md:6 pb-4">
          {t('title')}
        </h2>
        <div className="flex flex-col gap-4 xl:flex-row ">
          <ul className="grid xl:gap-y-6 xl:gap-x-10 md:gap-y-5 md:gap-x-6 gap-y-3 grid-cols-1 md:grid-cols-2">
